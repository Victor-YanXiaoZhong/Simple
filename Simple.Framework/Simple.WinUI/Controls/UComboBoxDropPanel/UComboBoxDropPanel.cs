...
namespace Simple.WinUI.Controls.PopupControl
{
    ...
    public class UComboBoxDropPanel : System.Windows.Forms.ComboBox, IPopupControlHost
    {
        #region Construction and destruction

        public UComboBoxDropPanel()
            : base()
        {
        ...
        public UComboBoxDropPanel(Control dropControl)
            : this()
        {
        ...
        public virtual void ShowDropDown()
        {
            if (m_popupCtrl != null && !IsDroppedDown)
            {
                ...
                if (m_timerAutoFocus == null)
                {
                    m_timerAutoFocus = new System.Windows.Forms.Timer();
        ...
        /// <summary>
        /// Automatic focus timer helps make sure drop-down control is focused for user input upon drop-down.
        /// </summary>
        private System.Windows.Forms.Timer m_timerAutoFocus;
